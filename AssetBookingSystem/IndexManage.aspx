<%@ Page Title="Asset Booking System" EnableEventValidation="false" Language="C#" MasterPageFile="~/systemManage.Master" AutoEventWireup="true" CodeBehind="IndexManage.aspx.cs" Inherits="AssetBookingSystem.IndexManager" %>
    ...
    <table id="LocationTable" class="style1">
                             ...
                             <tr>
                                 <td  class="style2">
                                     Room</td>
                                 <td class="style12">
                                     <asp:DropDownList ID="RoomTextBox" class="dropdownArrow1" runat="server" 
                                     Width="300px" 
                            ...
                            <tr>
                                 ...
                                 <td class="style10">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFinishDate" runat="server" ControlToValidate="FinishDate" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                             ...
                                             <td class="style10">
                                     <asp:DropDownList ID="FinishTime" class="dropdownArrow1" runat="server" 
                                     Width="70px"
        ...
        <br /><br /> <br /><asp:Label ID="timeError" CssClass="SameDayBooking" runat="server" Visible="false" Text="Your specified booking time is invalid, please check again!"></asp:Label> 
           ...
           <br /><asp:Label ID="LabelRefresh" CssClass="buttonUpdateResult" runat="server" Visible="false" Text="Changed something? Click on the button to update search result."></asp:Label><br /> <br /><br />
                ...
                <div class="containers" id="about"></div>
                     ...
                     <br /><asp:Label ID="ConfirmError" CssClass="SameDayBooking" runat="server" Visible="false" Text="Please choose your assets before confirming."></asp:Label> 
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:AssetBookingSystemConnectionString %>" SelectCommand="SELECT * FROM [tblAssets] WHERE ([Campus] = @Campus)">
                    <SelectParameters>
                            <asp:ControlParameter ControlID="CampusTextBox" Name="Campus" PropertyName="SelectedValue" Type="String" />
                        </SelectParameters>
